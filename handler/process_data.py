...
teen_code_url = 'https://gist.githubusercontent.com/nguyenvanhieuvn/7d9441c10b3c2739499fc5a4d9ea06fb/raw/df939245b3e841b62af115be4dcb3516dadc9fc5/teencode.txt'
teencode_file = 'teencode.txt'

response = requests.get(teen_code_url)
if response.status_code == 200:
    with open(teencode_file, 'w', encoding='utf-8') as f:
...
with open(teencode_file, encoding='utf-8') as f:
...
# # Word segmentation
# corenlp_path = subprocess.check_output('find / -name "VnCoreNLP-*.jar" 2>/dev/null', shell=True).decode('utf-8').strip()

# # Khởi tạo đối tượng VnCoreNLP với đường dẫn tới tệp .jar
# annotator = VnCoreNLP(corenlp_path)
# print("c")
